  ...
  head: () => ({
    meta: [
      { title: "Yhteystiedot — Lynevo Solutions" },
      {
        name: "description",
        content:
          "Varatkaa 30 minuutin tutustumispuhelu. Rakennamme suomalaisille tilitoimistoille järjestelmiä — ensimmäinen kuukausi veloituksetta. Takaamme 30 tunnin kuukausisäästön, todennettu ROI-raportilla.",
      },
    ],
  }),
